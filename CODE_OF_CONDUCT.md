...
We as members, contributors, and leaders pledge to make participation in the 8cli community
...
This project adopts the **Contributor Covenant, version 2.1**, as its code of conduct. The
full text – including expected behavior, unacceptable behavior, enforcement responsibilities,
scope, and enforcement guidelines – is published at:
...
to the project maintainers through GitHub's private reporting on the repository's
**Security**/**Report content** channels, or by contacting the maintainers directly. All
