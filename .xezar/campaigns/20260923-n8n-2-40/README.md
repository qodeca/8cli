...
|---|---|---|---|
| #31 | Local n8n 2.40.5 environment | PR #33 repair round 1 running (317cb32c) | then security re-check on codex/gpt-6-astra |
...
- 317cb32c (claude/opus, qodeca-priv, repair round 1) owns scripts/local-n8n/**, test/local-n8n.test.ts, docs/runbooks/local-n8n.md, test/e2e/setup/redact.ts on xez/df01cf60
