...
<!-- xezar:start – added by xez-onboard-opinionated -->
...
- `CODE_REVIEW.md` – how a change is judged, and the trust boundaries
...
Task pull requests target `develop`, the base branch named in `.xezar/config.json`, not the
default branch.
